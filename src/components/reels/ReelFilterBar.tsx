...
const CATEGORIES: { label: string; value: ReelCategory | "all" }[] = [
  { label: "ALL", value: "all" },
...
interface ReelFilterBarProps {
  active: ReelCategory | "all";
  onChange: (cat: ReelCategory | "all") => void;
}

export default function ReelFilterBar({ active, onChange }: ReelFilterBarProps) {
